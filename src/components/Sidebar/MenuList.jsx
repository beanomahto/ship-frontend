    ...
    <div style={{ overflowY: "auto", height: "calc(100% - 80px)" }}>
      ...
      >
        ...
        <Menu.SubMenu
          key="orders"
          title="Orders"
          icon={<MdShoppingCart size="1.4rem" />}
        >
          <Menu.Item key="allOrders">
            <Link to="/orders">
              <span style={{ fontWeight: 500 }}>All Orders</span>
            </Link>
          </Menu.Item>
          <Menu.Item key="deliveredOrders">
            <Link to="/orders/delivered">
              <span style={{ fontWeight: 500 }}>Delivered Orders</span>
            </Link>
          </Menu.Item>
        </Menu.SubMenu>
        {authUser?.role === "admin" && (
        ...
        <Menu.Item key="ndr" icon={<IoFileTrayFullOutline size="1.4rem" />}>
          <Link to="/ndr">
            <span style={{ fontWeight: 500 }}>NDR</span>
          </Link>
        </Menu.Item>
        ...
        <Menu.SubMenu
          key="finance"
          title="Finance"
          icon={<MdMoney size="1.6rem" />}
        >
          <Menu.Item key="cod_remittance">
            <Link to="finance/codremmitance">
              <span style={{ fontWeight: 500 }}>COD Remittance</span>
            </Link>
          </Menu.Item>
          ...
          <Menu.Item key="lost_damage">
            <Link to="finance/lost_damage">
              <span style={{ fontWeight: 500 }}>Lost/Damage Claim</span>
            </Link>
          </Menu.Item>
          {authUser?.role === "admin" && (
            <Menu.Item key="pricing">
              <Link to="finance/pricing">
                <span style={{ fontWeight: 500 }}>Pricing</span>
              </Link>
            </Menu.Item>
          )}
          <Menu.Item key="weightDiscrepancies">
            <Link to="finance/weight_discrepancies">
              <span style={{ fontWeight: 500 }}>Weight Discrepancies</span>
            </Link>
          </Menu.Item>
        ...
        <Menu.SubMenu key="tool" title="Tool" icon={<FaTools size="1.4rem" />}>
          <Menu.Item key="rateCalculator">
            <Link to="/ratecalculator">
              <span style={{ fontWeight: 500 }}>Rate Calculator</span>
            </Link>
          </Menu.Item>
          {/* <Menu.Item key='label' ><Link to='/label'>Label</Link></Menu.Item> */}
          <Menu.Item key="updLabel">
            <Link to="/updatelabel">
              <span style={{ fontWeight: 500 }}>UpdateLabel</span>
            </Link>
          </Menu.Item>
          <Menu.Item key="pcServiceability">
            <Link to="/pincodeservice">
              <span style={{ fontWeight: 500 }}>Pin Code Serviceablity</span>
            </Link>
          </Menu.Item>
          <Menu.Item key="channelIntegration">
            <Link to="/channelintegration">
              <span style={{ fontWeight: 500 }}>Channel Integration</span>
            </Link>
          </Menu.Item>
        ...
        <Menu.Item key="setting" icon={<CiSettings size="1.6rem" />}>
          <Link to="/settings">
            <span style={{ fontWeight: 500 }}>Setting</span>
          </Link>
        </Menu.Item>
      </Menu>
    </div>
