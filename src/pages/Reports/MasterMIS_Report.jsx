...
const AdminMIS_Report = () => {
  ...
  const handleDownloadOutForDelivery = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/report/outfordeliveryseller",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDownloadInTransit = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/report/getintransitseller",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDownloadWallet = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/report/gettranscationsseller",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
