...
const AdminMIS_Report = () => {
  ...
  const handleMisSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/api/report/misreport",
        {
          method: "POST",
          headers: {
  ...
  const handleNdrSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/api/report/generatendr",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleOutForDeliverySubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/api/report/outfordelivery",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleInTransitSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/api/report/getintransit",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handlewalletSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/api/report/gettranscations",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSellerSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/report/userdetailsexcel",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
