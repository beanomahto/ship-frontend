...
import Img from '../../utils/images.png'
        ...
        <form onSubmit={handleSubmit}>
            <div className="main-user-info">
                <div className="user-input-box">
                  ...
                  <Select className='selector' placeholder='Select Courier Partner'
                                value={inputs.deliveryPartner}
                                onChange={(e) => setInputs({ ...inputs, deliveryPartner: e })}
                                options={[
                ...
                <div className="user-input-box">
                    ...
                    <input
                        ...
                        value={inputs.pickupPincode}
                            onChange={(e) => setInputs({ ...inputs, pickupPincode: e.target.value })}
                    />
                </div>
                <div className="user-input-box">
                    <label htmlFor="username">Destination Pin Code</label>
                    <input
                        type="number"
                        placeholder="Enter Username"
                        value={inputs.deliveryPincode}
                            onChange={(e) => setInputs({ ...inputs, deliveryPincode: e.target.value })}
                    />
                </div>
                ...
                <div className="user-input-box">
                    ...
                    <Select style={{marginRight:'15rem'}} placeholder='Select Payment Method'
            ...
            <div className="form-submit-btn" style={{display:'flex', gap:'2rem'}} >
                <button className="submit" type="submit">Submit</button>
              <h1>{loading ? "Calculating..." : rateResult ? `Rate: ${rateResult.cost}` : ''}</h1>
            </div>
        </form>
    </div>
    <div style={{ width: '30%', padding: '10px 16px',borderRadius:'2rem', display:'flex', backgroundColor:'white' }} className='imgDiv'>
